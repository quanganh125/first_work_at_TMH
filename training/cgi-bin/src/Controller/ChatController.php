...
class ChatController extends AppController
{
    ...
    // Show feed page
        ...
        $new_message = $this->tFeeds->newEmptyEntity();
            ...
            $new_message->stamp_name =  $this->request->getQuery('stamp_name');
           
            if(!empty($new_message->stamp_name)){
        ...
        if(($new_message->image_file_name==NULL) &&  ($new_message->message== NULL) && ($new_message->stamp_name == NULL))
